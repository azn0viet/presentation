...
import com.commonsware.cwac.preso.AspectLockedFrameLayout;
import com.commonsware.cwac.preso.Mirror;
import com.commonsware.cwac.preso.MirroringFrameLayout;

abstract public class MirroringFragment extends Fragment {
	abstract protected View onCreateMirroredContent(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState);
	...
	final public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		source.addView(onCreateMirroredContent(inflater, source, savedInstanceState));

		aspectLock = new AspectLockedFrameLayout(getActivity());
		aspectLock.addView(source, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT,
				Gravity.CENTER));
